...
data = make_regression(n_samples=1000, n_features=4, n_informative=2, bias=15, noise=10.0, random_state=115)
X, y = data[0], data[1]
...
for name, model in models.items():
    ...
    if "Sklearn" in name:
        ...
        model.fit(X_train, y_train, learning_rate=0.05, epochs=1000)
