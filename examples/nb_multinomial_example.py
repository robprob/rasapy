...
from rasapy.bayesian import NaiveBayesClassification
from sklearn.naive_bayes import MultinomialNB

data = make_classification(n_samples=100, n_features=10, n_informative=4, class_sep=2.0, random_state=115)
X, y = data[0], data[1]
