...
from rasapy.trees import TreeRegression
from sklearn.tree import DecisionTreeRegressor

data = make_regression(1000, 4, bias=15, noise=0.0, random_state=115)
X, y = data[0], data[1]
...
models = {
    ...
    "Min Samples Split 3": TreeRegression(min_samples_split=3, random_state=115),
